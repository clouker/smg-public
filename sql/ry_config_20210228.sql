DROP DATABASE IF EXISTS `smg_public_config`;

CREATE DATABASE `smg_public_config` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
values (1, 'application-dev.yml', 'DEFAULT_GROUP',
       ...
       (2, 'smg-public-gateway-dev.yml', 'DEFAULT_GROUP',
        'spring:\r\n  redis:\r\n    host: 192.168.0.103\r\n    port: 6379\r\n    password: 123456 \r\n  cloud:\r\n    gateway:\r\n      discovery:\r\n        locator:\r\n          lowerCaseServiceId: true\r\n          enabled: true\r\n      routes:\r\n        # 认证中心\r\n        - id: smg-public-auth\r\n          uri: lb://smg-public-auth\r\n          predicates:\r\n            - Path=/auth/**\r\n          filters:\r\n            # 验证码处理\r\n            - CacheRequestFilter\r\n            - ValidateCodeFilter\r\n            - StripPrefix=1\r\n        # 代码生成\r\n        - id: smg-public-gen\r\n          uri: lb://smg-public-gen\r\n          predicates:\r\n            - Path=/code/**\r\n          filters:\r\n            - StripPrefix=1\r\n        # 定时任务\r\n        - id: smg-public-job\r\n          uri: lb://smg-public-job\r\n          predicates:\r\n            - Path=/schedule/**\r\n          filters:\r\n            - StripPrefix=1\r\n        # 系统模块\r\n        - id: smg-public-system\r\n          uri: lb://smg-public-system\r\n          predicates:\r\n            - Path=/system/**\r\n          filters:\r\n            - StripPrefix=1\r\n        # 文件服务\r\n        - id: smg-public-file\r\n          uri: lb://smg-public-file\r\n          predicates:\r\n            - Path=/file/**\r\n          filters:\r\n            - StripPrefix=1\r\n\r\n# 不校验白名单\r\nignore:\r\n  whites:\r\n    - /auth/logout\r\n    - /auth/login\r\n    - /*/v2/api-docs\r\n    - /csrf\r\n',
       ...
       (7, 'smg-public-job-dev.yml', 'DEFAULT_GROUP',
       ...
       (8, 'smg-public-file-dev.yml', 'DEFAULT_GROUP',
