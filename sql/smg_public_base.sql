# DROP DATABASE IF EXISTS `smg_public_base`;
#
# CREATE DATABASE `smg_public_base` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
#
# SET NAMES utf8mb4;
...
insert into sys_menu
values ('108', '日志管理', '1', '10', 'log', '', 1, 0, 'M', '0', '0', '', 'log', 'admin', sysdate(), '', null, '日志管理菜单');
insert into sys_menu
...
-- 通知公告按钮
insert into sys_menu
values ('1041', '公告查询', '107', '1', '#', '', 1, 0, 'F', '0', '0', 'system:notice:query', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1042', '公告新增', '107', '2', '#', '', 1, 0, 'F', '0', '0', 'system:notice:add', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1043', '公告修改', '107', '3', '#', '', 1, 0, 'F', '0', '0', 'system:notice:edit', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1044', '公告删除', '107', '4', '#', '', 1, 0, 'F', '0', '0', 'system:notice:remove', '#', 'admin', sysdate(), '',
        null, '');
-- 操作日志按钮
insert into sys_menu
values ('1045', '操作查询', '500', '1', '#', '', 1, 0, 'F', '0', '0', 'system:operlog:query', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1046', '操作删除', '500', '2', '#', '', 1, 0, 'F', '0', '0', 'system:operlog:remove', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1047', '日志导出', '500', '4', '#', '', 1, 0, 'F', '0', '0', 'system:operlog:export', '#', 'admin', sysdate(), '',
        null, '');
-- 登录日志按钮
insert into sys_menu
values ('1048', '登录查询', '501', '1', '#', '', 1, 0, 'F', '0', '0', 'system:logininfor:query', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1049', '登录删除', '501', '2', '#', '', 1, 0, 'F', '0', '0', 'system:logininfor:remove', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1050', '日志导出', '501', '3', '#', '', 1, 0, 'F', '0', '0', 'system:logininfor:export', '#', 'admin', sysdate(),
        '', null, '');
-- 在线用户按钮
insert into sys_menu
values ('1051', '在线查询', '109', '1', '#', '', 1, 0, 'F', '0', '0', 'monitor:online:query', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1052', '批量强退', '109', '2', '#', '', 1, 0, 'F', '0', '0', 'monitor:online:batchLogout', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1053', '单条强退', '109', '3', '#', '', 1, 0, 'F', '0', '0', 'monitor:online:forceLogout', '#', 'admin', sysdate(),
        '', null, '');
-- 定时任务按钮
insert into sys_menu
values ('1054', '任务查询', '110', '1', '#', '', 1, 0, 'F', '0', '0', 'monitor:job:query', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1055', '任务新增', '110', '2', '#', '', 1, 0, 'F', '0', '0', 'monitor:job:add', '#', 'admin', sysdate(), '', null,
        '');
insert into sys_menu
values ('1056', '任务修改', '110', '3', '#', '', 1, 0, 'F', '0', '0', 'monitor:job:edit', '#', 'admin', sysdate(), '', null,
        '');
insert into sys_menu
values ('1057', '任务删除', '110', '4', '#', '', 1, 0, 'F', '0', '0', 'monitor:job:remove', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1058', '状态修改', '110', '5', '#', '', 1, 0, 'F', '0', '0', 'monitor:job:changeStatus', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1059', '任务导出', '110', '7', '#', '', 1, 0, 'F', '0', '0', 'monitor:job:export', '#', 'admin', sysdate(), '',
        null, '');
-- 代码生成按钮
insert into sys_menu
values ('1060', '生成查询', '115', '1', '#', '', 1, 0, 'F', '0', '0', 'tool:gen:query', '#', 'admin', sysdate(), '', null,
        '');
insert into sys_menu
values ('1061', '生成修改', '115', '2', '#', '', 1, 0, 'F', '0', '0', 'tool:gen:edit', '#', 'admin', sysdate(), '', null,
        '');
insert into sys_menu
values ('1062', '生成删除', '115', '3', '#', '', 1, 0, 'F', '0', '0', 'tool:gen:remove', '#', 'admin', sysdate(), '', null,
        '');
insert into sys_menu
values ('1063', '导入代码', '115', '2', '#', '', 1, 0, 'F', '0', '0', 'tool:gen:import', '#', 'admin', sysdate(), '', null,
        '');
insert into sys_menu
values ('1064', '预览代码', '115', '4', '#', '', 1, 0, 'F', '0', '0', 'tool:gen:preview', '#', 'admin', sysdate(), '', null,
        '');
insert into sys_menu
values ('1065', '生成代码', '115', '5', '#', '', 1, 0, 'F', '0', '0', 'tool:gen:code', '#', 'admin', sysdate(), '', null,
        '');
...
insert into sys_dict_type
values (11, '授权类型', 'sys_grant_type', '0', 'admin', sysdate(), '', null, '授权类型列表');
...
insert into sys_dict_data
values (29, 1, '授权码模式', 'authorization_code', 'sys_grant_type', '', '', 'N', '0', 'admin', sysdate(), '', null,
        '授权码模式');
insert into sys_dict_data
values (30, 2, '密码模式', 'password', 'sys_grant_type', '', '', 'N', '0', 'admin', sysdate(), '', null, '密码模式');
insert into sys_dict_data
values (31, 3, '客户端模式', 'client_credentials', 'sys_grant_type', '', '', 'N', '0', 'admin', sysdate(), '', null,
        '客户端模式');
insert into sys_dict_data
values (32, 4, '简化模式', 'implicit', 'sys_grant_type', '', '', 'N', '0', 'admin', sysdate(), '', null, '简化模式');
insert into sys_dict_data
values (33, 5, '刷新模式', 'refresh_token', 'sys_grant_type', '', '', 'N', '0', 'admin', sysdate(), '', null, '刷新模式');
