package org.clc.common.security.aspect;
...
import org.clc.common.core.exception.PreAuthorizeException;
...
public class PreAuthorizeAspect {
    ...
    @Around("@annotation(org.clc.common.security.annotation.PreAuthorize)")
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        if (!ObjectUtils.isEmpty(annotation.hasPermi())) {
            if (hasPermi(annotation.hasPermi())) {
                return point.proceed();
            }
            throw new PreAuthorizeException();
        } else if (!ObjectUtils.isEmpty(annotation.lacksPermi())) {
            ...
            throw new PreAuthorizeException();
        } else if (!ObjectUtils.isEmpty(annotation.hasRole())) {
            if (hasRole(annotation.hasRole())) {
                return point.proceed();
            }
            throw new PreAuthorizeException();
        } else if (!ObjectUtils.isEmpty(annotation.lacksRole())) {
